...
ICalculaDescontoStatusContaFactory descConta = new CalculaDescontosStatusFactory();

GerenciadorDeDescontos gerDesc = new GerenciadorDeDescontos(descConta, descFide);
